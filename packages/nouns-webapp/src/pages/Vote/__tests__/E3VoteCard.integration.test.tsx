...
describe('E3VoteCard Integration in VotePage', () => {
  it('renders E3VoteCard when chainId is 31337 and sidecarAddress is available', () => {
    render(<VotePage />);
    expect(screen.getByTestId('e3-vote-card')).toBeDefined();
    expect(screen.getByText('Cast Secret Vote')).toBeDefined();
  });
});

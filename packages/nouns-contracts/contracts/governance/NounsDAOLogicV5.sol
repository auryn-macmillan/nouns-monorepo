...
/// @title The Nouns DAO logic version 5
...
contract NounsDAOLogicV5 is NounsDAOStorage, NounsDAOEventsV3 {
    ...
    /**
     * @notice Function used to propose a new E3 proposal. Sender must have delegates above the proposal threshold
     * @param targets Target addresses for proposal calls
     * @param values Eth values for proposal calls
     * @param signatures Function signatures for proposal calls
     * @param calldatas Calldatas for proposal calls
     * @param description String description of the proposal
     * @param merkleRoot Merkle root of eligible encrypted voters
    ...
    function castVote(uint256 proposalId, uint8 support) external {
        ds.castVoteChecked(proposalId, support);
    }
    ...
    function castRefundableVote(uint256 proposalId, uint8 support) external {
        ds.castRefundableVoteChecked(proposalId, support, 0);
    }
    ...
    function castRefundableVote(uint256 proposalId, uint8 support, uint32 clientId) external {
        ds.castRefundableVoteChecked(proposalId, support, clientId);
    }
    ...
    function castRefundableVoteWithReason(uint256 proposalId, uint8 support, string calldata reason) public {
        ds.castRefundableVoteWithReasonChecked(proposalId, support, reason, 0);
    }
    ...
    function castRefundableVoteWithReason(
        ...
        ds.castRefundableVoteWithReasonChecked(proposalId, support, reason, clientId);
    }
    ...
    function castVoteWithReason(uint256 proposalId, uint8 support, string calldata reason) external {
        ds.castVoteWithReasonChecked(proposalId, support, reason);
    }

    function castE3Vote(uint256 proposalId) external {
        ds.castE3Vote(proposalId, msg.sender);
    }
    ...
    function setCrispVotingSidecar(address sidecar) external {
        ds.setCrispVotingSidecar(sidecar);
    }
